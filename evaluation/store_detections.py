"""Store detections of a model on a set of images in the right format for mAP computation"""
...
DETECTION_FILE          = 'evaluation/detection_faster_rcnn_resnet/'
...
with ip.detection_graph.as_default():
    with tf.compat.v1.Session(graph=ip.detection_graph) as sess:
        ...
        #mean computational time per image:
        print("avg time", time_tot/(i-1))
